...
current_game_state = {'game': {'id': '37f560f5-08e9-4d0a-83b4-00490290c417', 'ruleset': {'name': 'standard', 'version': 'v1.2.3', 'settings': {'foodSpawnChance': 15, 'minimumFood': 1, 'hazardDamagePerTurn': 0, 'hazardMap': '', 'hazardMapAuthor': '', 'royale': {'shrinkEveryNTurns': 0}, 'squad': {'allowBodyCollisions': False, 'sharedElimination': False, 'sharedHealth': False, 'sharedLength': False}}}, 'map': 'standard', 'timeout': 500, 'source': 'custom'}, 'turn': 29, 'board': {'height': 11, 'width': 11, 'snakes': [{'id': 'gs_VqKFDxYGmWWWdXjSdhqScBT7', 'name': '2023_Test', 'latency': '152', 'health': 96, 'body': [{'x': 3, 'y': 10}, {'x': 4, 'y': 10}, {'x': 5, 'y': 10}, {'x': 6, 'y': 10}, {'x': 6, 'y': 9}, {'x': 5, 'y': 9}], 'head': {'x': 3, 'y': 10}, 'length': 6, 'shout': '', 'squad': '', 'customizations': {'color': '#00ff00', 'head': 'default', 'tail': 'default'}}, {'id': 'gs_mG99cYpP6WB8gjqGkfjYxTGb', 'name': 'Devious Devin', 'latency': '413', 'health': 91, 'body': [{'x': 2, 'y': 9}, {'x': 3, 'y': 9}, {'x': 3, 'y': 8}, {'x': 3, 'y': 7}, {'x': 3, 'y': 6}], 'head': {'x': 2, 'y': 9}, 'length': 5, 'shout': '', 'squad': '', 'customizations': {'color': '#99cc00', 'head': 'trans-rights-scarf', 'tail': 'rbc-necktie'}}], 'food': [{'x': 1, 'y': 10}, {'x': 0, 'y': 9}, {'x': 4, 'y': 2}], 'hazards': []}, 'you': {'id': 'gs_VqKFDxYGmWWWdXjSdhqScBT7', 'name': '2023_Test', 'latency': '152', 'health': 96, 'body': [{'x': 3, 'y': 10}, {'x': 4, 'y': 10}, {'x': 5, 'y': 10}, {'x': 6, 'y': 10}, {'x': 6, 'y': 9}, {'x': 5, 'y': 9}], 'head': {'x': 3, 'y': 10}, 'length': 6, 'shout': '', 'squad': '', 'customizations': {'color': '#00ff00', 'head': 'default', 'tail': 'default'}}}
